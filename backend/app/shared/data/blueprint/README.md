# Business Blueprint Source Files

Drop the following PDFs (or their extracted `.txt` versions) into this folder so the Blueprint module can be aligned to your real product workflow and ontology:

- `Module 2 Architectural Workflow (1).pdf`
