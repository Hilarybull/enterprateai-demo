...
export default function BusinessPlanPage() {
  ...
  // Adopting/extracting a live plan is Decision Engine+ (matches
  // live_plan_import_extract / live_plan_scenario_adopt server-side) —
  // generating a business plan document itself (on /blueprint) stays free.
        ...
        >
          ...
          {!businessId ? (
            ...
            <div className="space-y-4">
              ...
              {!previewData && !hasLivePlanAccess && (
                <div className="rounded-2xl border border-indigo-200 bg-indigo-50/30 p-5 text-center">
                  <div className="mb-1 text-sm font-semibold text-slate-900">Adopting a Live Plan needs Decision Engine</div>
                  <p className="mx-auto mb-4 max-w-md text-xs text-slate-500">
                    Generating a business plan document is free on every plan. Turning it into a Live Plan
                    that tracks against your actual Catalogue and Financials data is a Decision Engine feature.
                  </p>
                  <Link
                    to="/pricing"
                  ...
                  >
                    Upgrade to Decision Engine
                  </Link>
                </div>
              )}
              {!previewData && hasLivePlanAccess && (<div className="rounded-2xl border border-indigo-200 bg-indigo-50/30 p-5">
