...
export const TOUR_STEPS = [
  ...
  },
  {
    ...
    description: "Browse products and services from other businesses on the platform, or publish your own profile so buyers and partners can discover you. Send and receive quotation requests in one click.",
    hint: "Search by product, service, or business name to explore the marketplace.",
  },
  {
