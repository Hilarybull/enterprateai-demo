...
export default function CookieBanner() {
  ...
  if (state === "saved") {
    return (
      <div style={{ zIndex: 35 }} className="pointer-events-auto hidden sm:block fixed bottom-0 left-0 right-0 border-t border-transparent bg-transparent px-6 py-3 hover:bg-white hover:border-slate-200 hover:shadow-md transition-all duration-200 dark:hover:bg-slate-900 dark:hover:border-slate-700">
